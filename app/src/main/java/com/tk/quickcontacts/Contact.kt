...
// Helper function to get the primary phone number or first available
fun Contact.getPrimaryPhoneNumber(): String {
    return if (phoneNumbers.isNotEmpty()) phoneNumbers.first() else phoneNumber
} 